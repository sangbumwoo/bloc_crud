...
import 'package:bloc_crud/bloc/bloc/crud_bloc.dart';
import 'package:bloc_crud/page/add_todo.dart';
import 'package:bloc_crud/splash_screen/splash_screen.dart';
...
class _SqFliteDemoState extends State<SqFliteDemo> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: BlocBuilder<CrudBloc, TodoState>(
